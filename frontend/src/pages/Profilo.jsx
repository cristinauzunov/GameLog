...
function Profilo() {
  const { utente: aggiornaUtente } = useContext(AuthContext);
    ...
    <Container className="mt-4" style={{ maxWidth: "700px" }}>
        ...
        <Card.Body>
          <Row className="align-items-center">
            ...
            <Col>
              ...
              <p className="text-muted mb-2">{utente.email}</p>
              <button
                type="button"
                className="btn-gamelog-sm"
                onClick={() => navigate("/utente/" + utente.id)}
              >
                Vedi il mio profilo
              </button>
            </Col>
      ...
      <Card>
        <Card.Body>
          ...
          <button type="button" className="btn-gamelog" onClick={salva}>
            Salva modifiche
          </button>
        </Card.Body>
      </Card>
